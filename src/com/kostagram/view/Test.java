...
public class Test extends JFrame {
    ...
    private static JButton likeButton;
    private static JButton commentButton;
    ...
    private static class PostRenderer extends DefaultListCellRenderer { // 커스텀 리스트 셀 렌더러 클래스
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            likeButton = createIconButton("like"); // 좋아요 버튼 생성
            commentButton = createIconButton("comment"); // 댓글 버튼 생성
