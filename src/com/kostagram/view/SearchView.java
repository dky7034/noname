...
public class SearchView extends JFrame {
    ...
    public SearchView() {
        ...
        // 커스텀 스크롤바 UI 적용
        scrollPane.getVerticalScrollBar().setUI(new PrettyScrollBar()); // 수직 스크롤바에 커스텀 UI 적용
        scrollPane.getHorizontalScrollBar().setUI(new PrettyScrollBar()); // 수평 스크롤바에 커스텀 UI 적용
